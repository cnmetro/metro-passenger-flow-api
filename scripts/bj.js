  ...
  while (true) {
    ...
    try {
      ...
      cards[0].card_group.forEach(card => {
        ...
        if (card.mblog.user.id === WEIBO_ID && text.indexOf('昨日客流') > -1) {
